...
An experimental WDL file for using `cudamapper` has been made avaialble in [cudamapper WDL](wdl/SuperMiniTyper_cudamapper.wdl) and Workflow WDL file (`cudamapper | fpa | seqwish`) is available in [here](wdl/SuperMiniTyper_Pipeline1_GPU.wdl)
